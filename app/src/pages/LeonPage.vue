  ...
  <div class="location-page">
    <div class="location-hero">
      ...
      <div class="hero-overlay">
        <h1>{{ location.name }}</h1>
        <p class="days-info">Day 8 of your trip</p>
      </div>
    </div>
      ...
      <section class="activities-section">
        ...
        <div class="activities-grid">
          <div
            ...
            :key="activity.name"
            class="activity-card"
            :class="{ featured: activity.name === 'Volcano Boarding' }"
          >
            <div v-if="activity.name === 'Volcano Boarding'" class="featured-badge">
              The Main Event
            </div>
            <h3>{{ activity.name }}</h3>
...
.hero-overlay {
  ...
  right: 0;
  bottom: 0;
  background: linear-gradient(135deg, rgba(45, 95, 79, 0.7) 0%, rgba(26, 77, 62, 0.7) 100%);
  display: flex;
